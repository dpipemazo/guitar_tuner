/*****************************************************************************
* Filename:          D:\Digilent\Projects\Atlys\Atlys_12_2_RevC_BIST/drivers/d_usb_epp_dstm_v1_00_a/src/d_usb_epp_dstm_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the d_usb_epp_dstm driver
...
XStatus D_USB_EPP_DSTM_SelfTest(void * baseaddr_p)
{
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg0(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg1(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg2(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg3(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg4(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg5(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg6(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg7(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg8(baseaddr, 0, 9);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg8(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg9(baseaddr, 0, 10);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg9(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg10(baseaddr, 0, 11);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg10(baseaddr, 0);
  ...
  D_USB_EPP_DSTM_mWriteSlaveReg11(baseaddr, 0, 12);
  Reg32Value = D_USB_EPP_DSTM_mReadSlaveReg11(baseaddr, 0);
