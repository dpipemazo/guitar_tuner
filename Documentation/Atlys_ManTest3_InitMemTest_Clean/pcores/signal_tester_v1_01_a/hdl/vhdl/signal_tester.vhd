------------------------------------------------------------------------------
-- signal_tester.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          signal_tester.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Mon Aug 02 10:51:00 2010 (by Create and Import Peripheral Wizard)
...
library signal_tester_v1_01_a;
use signal_tester_v1_01_a.user_logic;
...
end entity signal_tester;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of signal_tester is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity signal_tester_v1_01_a.user_logic
    generic map
    (
