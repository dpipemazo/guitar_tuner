------------------------------------------------------------------------------
-- usb_epp_if.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library usb_epp_if_v1_00_a;
use usb_epp_if_v1_00_a.usb_epp_imp;
...
end entity usb_epp_if;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of usb_epp_if is
...
begin
  ...
  ------------------------------------------
  USB_EPP_IMP_I : entity usb_epp_if_v1_00_a.usb_epp_imp
    generic map
    (
     -- ADD USER GENERICS BELOW THIS LINE ---------------
     C_NUM_USER_REGS                => C_NUM_USER_REGS,
     C_PLB_CLK_TO_SPL_RATE_RATIO    => C_PLB_CLK_TO_SPL_RATE_RATIO,
     -- ADD USER GENERICS ABOVE THIS LINE ---------------
